...
INDIR=/scratch.global/kaltendo/gatk_temp/NAM_GATK/Quality_Control/Quality_Control_Fastq

# The directory in which the output .bam files will be placed
OUTDIR=/scratch.global/kaltendo/gatk_temp/NAM_GATK/Read_Mapping

# Name of the current pipeline project
PROJECT='NAM_GATK'

# The path to the basename of the indexed reference genome
REFINDEX=/home/janderso/shared/IWG_v1_genome/annotated_v2_release/index/Thinopyrum_intermedium.mainGenome
...
QUEUE_SETTINGS='-l walltime=53:00:00,mem=22gb,nodes=1:ppn=16'
...
BOWTIE_SETTINGS='-q --end-to-end -D 20 -R 3 -N 0 -L 20 -i S,1,0.30 --n-ceil C,0,0 --score-min L,-6,0 -k 2 --phred33 --seed 3'
