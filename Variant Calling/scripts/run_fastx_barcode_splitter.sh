...
INDIR=/home/janderso/shared/WGN_2

# The directory to output the demultiplexed fastq files
OUTDIR=/scratch.global/kaltendo/gatk_temp/NAM_GATK_check/

# The key file with columns: Flowcell Lane Barcode Sample PlateName Row Column
KEYFILE=/home/janderso/kaltendo/NAM_GATK/gatk_key.txt
...
QUEUE_SETTINGS='-l walltime=96:00:00,mem=16gb'
...
FASTX_SETTINGS='--bol --mismatches 0'
