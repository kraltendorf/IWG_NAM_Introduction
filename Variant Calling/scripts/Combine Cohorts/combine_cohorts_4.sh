...
#PBS -q small
#PBS -N combine_cohorts_4
#PBS -e combine_cohorts_4.error
#PBS -o combine_cohorts_4.output
#PBS -A janderso
...
--variant CC680ANXX_4_cohort.g.vcf ${GATK_SETTINGS} \
-O /home/janderso/kaltendo/NAM_GATK/GBarleyS/Pipeline/GATK_Pipeline/GenotypeGVCF/NAM_GATK/Raw_Variants/combine_cohorts_4.g.vcf
