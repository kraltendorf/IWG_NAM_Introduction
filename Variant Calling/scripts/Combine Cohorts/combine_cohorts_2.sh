...
#PBS -q small
#PBS -N combine_cohorts_2
#PBS -e combine_cohorts_2.error
#PBS -o combine_cohorts_2.output
#PBS -A janderso
...
--variant CBEEGANXX_8_cohort.g.vcf ${GATK_SETTINGS} \
-O /home/janderso/kaltendo/NAM_GATK/GBarleyS/Pipeline/GATK_Pipeline/GenotypeGVCF/NAM_GATK/Raw_Variants/combine_cohorts_2.g.vcf
